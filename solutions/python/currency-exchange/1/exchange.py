...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # Calculate the actual exchange rate including the spread fee
    actual_rate = exchange_rate * (1 + spread / 100)
    
    # Determine the raw amount of new currency you can afford
    total_currency = budget / actual_rate
    
    # Round down to the nearest full bill (denomination)
